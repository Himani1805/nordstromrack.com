  ...
  return (
    <Box width={"100%"} justifyContent={"space-between"} >
      ...
      <Flex width={"100%"} padding={"20px"} >
        <Flex width={"20%"}>
          <Image src="/Static/Images/df3a0d48-0df8-483c-81af-7e456c0a47bb.svg" width={"120px"}/>
        </Flex>
        <Flex width={"50%"}>
          <InputGroup border={"1px solid #838D91"} >
            <InputLeftElement>
              <Image src="/Static/Images/download%20(5).svg" width={"20px"}/>
            </InputLeftElement>
        ...
        <Flex width={"30%"} justifyContent={"space-evenly"}>
          ...
          <Image src="/Static/Images/download%20(3).svg" width={"25px"} />
